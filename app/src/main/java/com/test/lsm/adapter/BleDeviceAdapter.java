...
public class BleDeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = View.inflate(context, R.layout.lv_item_ble_bt_device, null);
        ...
        if (bleDevice != null) {
            ...
            double distance = Math.pow (10,(Math.abs(rssi) - 59) / (10 * 2.0));
            DecimalFormat    df   = new DecimalFormat("######0.00");
            holder.txt_rssi.setText(""+df.format(distance)+" m");
            if (isConnected) {
