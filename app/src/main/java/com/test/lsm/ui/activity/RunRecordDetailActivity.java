...
public class RunRecordDetailActivity extends LsmBaseActivity {
    ...
    public void beforeInit() {
        ...
        mGson = new Gson();
        recordId = getIntent().getIntExtra("run_record_id" , -1);
    }
    ...
    protected void initData() {
        ...
        apiMethodManager.getHealthInfoDtl(""+recordId, new IRequestCallback<GetHealthInfoDtlReturn>() {
            ...
            public void onFailure(Throwable throwable) {
                MyToast.showLong(RunRecordDetailActivity.this, "数据获取失败：" + throwable.getMessage());
            }
        });
    }
    ...
    public static void startAction(Activity activity, int recordId) {
        Intent intent = new Intent(activity, RunRecordDetailActivity.class);
        intent.putExtra("run_record_id", recordId);
