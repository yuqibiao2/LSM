...
public:
    ...
    double* Diff(double* data, int length, int target); //target:起始index
    double* CenterDiff(double* data, int length, int target);
    double* Composite(double*data, int length, int target);
